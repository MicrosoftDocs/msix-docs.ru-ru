...
- Чтобы продолжить редактировать содержимое и свойства пакета MSIX перед его сохранением, щелкните **Редактор пакетов**, чтобы открыть [редактор пакетов](https://docs.microsoft.com/windows/msix/packaging-tool/package-editor).
- Щелкните **Создать**, чтобы создать пакет MSIX.

Когда пакет будет создан, в средстве отобразится всплывающее окно с именем, издателем, расположением для сохранения журналов и расположением для сохранения созданного пакета. После закрытия этого всплывающего окна вы будете перенаправлены на страницу приветствия. Вы также можете запустить **редактор пакетов**, чтобы просмотреть и изменить содержимое и свойства пакета.

...
Если возникли проблемы при использовании приложения, нажмите клавиши **Windows+F**, чтобы открыть **Центр отзывов**. Предоставьте как можно больше сведений, чтобы мы могли выполнить диагностику и устранить проблему. Используйте категории **applications** > **MSIX Packaging Tool** , чтобы получить обратную связь непосредственно с нами.

...
+ __Убедитесь, что все расширения, установленные приложением, будут установлены там, где установлено приложение__. Windows позволяет пользователям и ИТ Manager изменять расположение установки по умолчанию для пакетов.  См. раздел "Settings-> System-> Storage-> Дополнительные параметры хранилища — > изменение места сохранения нового содержимого в. > новые приложения будут сохраняться в".  Если вы устанавливаете расширение вместе с приложением, убедитесь, что расширение не имеет дополнительных ограничений для папки установки.  Например, некоторые расширения могут отключить установку расширения на несистемные диски.  Это приведет к ошибке 0x80073D01 (ERROR_DEPLOYMENT_BLOCKED_BY_POLICY), если расположение по умолчанию было изменено. 

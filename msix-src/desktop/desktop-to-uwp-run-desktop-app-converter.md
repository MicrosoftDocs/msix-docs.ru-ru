...
> [!NOTE]
> Программа Desktop App Converter считается устаревшей. Мы рекомендуем использовать [средство упаковки MSIX](../packaging-tool/create-app-package-msi-vm.md) вместо этого.
...
См. в разделе [распределить упакованные настольного приложения](/windows/apps/desktop/modernize/desktop-to-uwp-distribute)

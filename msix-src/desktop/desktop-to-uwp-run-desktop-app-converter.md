...
> [!NOTE]
> Программа Desktop App Converter считается устаревшей. Мы рекомендуем использовать [средство упаковки MSIX](../mpt-overview.md) вместо этого.
...
См. в разделе [запуска, отладки и тестирования упакованные приложения рабочего стола](https://docs.microsoft.com/windows/uwp/desktop-to-uwp-debug)

...
: heavy_check_mark: простое назначение удостоверения для приложения из имени, которое вы уже зарезервировано в [центре партнеров](https://partner.microsoft.com/dashboard).

...
> [!IMPORTANT]
> Если вы разрабатываете приложение C++, необходимо настроить свойства файла `SourceAppxContentGroupMap.xml` . Задайте свойству `Content` значение **true**, а свойству `File Type` — значение **XML File**.
...
#### <a name="tips-and-tricks-for-using-wildcards"></a>Советы и рекомендации по использованию подстановочных знаков<a name="wildcards"></a>

---
title: Вводные сведения о пакетах ресурсов
description: Пакеты ресурсов — это тип пакета, который выступает в качестве централизованного расположения для общих файлов приложения.
ms.date: 07/02/2019
ms.topic: article

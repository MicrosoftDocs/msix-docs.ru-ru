...
1. Убедитесь, что для **минимальной версии целевой платформы** приложения задано значение: 10.0.15063.0 или более поздней версии.
...
Обратите внимание, что, как `Bundle.Mapping.txt` и в случае с дополнительными пакетами, файл для связанных наборов будет работать только в Windows 10, версии 1703 или более поздней. Кроме того, минимальная версия целевой платформы приложения должна быть равна 10.0.15063.0 или выше.

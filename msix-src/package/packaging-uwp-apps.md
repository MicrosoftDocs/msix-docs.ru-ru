...
ms.openlocfilehash: 8ceab8a319a6ece56f84cceb64b208712a2d205e
ms.sourcegitcommit: 8a75eca405536c5f9f7c4fd35dd34c229be7fa3e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/31/2019
ms.locfileid: "68689803"
---
...
Чтобы загружать неопубликованные приложение на устройстве с Windows 10 Mobile, используйте средство [WinAppDeployCmd. exe](https://docs.microsoft.com/windows/uwp/packaging/install-universal-windows-apps-with-the-winappdeploycmd-tool) . Для настольных компьютеров, ноутбуков и планшетов следуйте приведенным ниже инструкциям.

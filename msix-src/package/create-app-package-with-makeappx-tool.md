...
ms.custom: RS5
ms.openlocfilehash: 6ea1e3bc5dbea0531d2d397a523db8b76063d4fe
ms.sourcegitcommit: 37bc5d6ef6be2ffa373c0aeacea4226829feee02
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/07/2020
ms.locfileid: "77072904"
---
# <a name="create-an-msix-package-or-bundle-with-makeappxexe"></a>Создание пакета MSIX или набора с помощью программе makeappx. exe
...
- x64: C:\Program Files (x86) \Windows Kits\10\bin\\&lt;номер сборки&gt;\x64\makeappx.exe
...
|---------------|---------------------------------------|
| pack          | Создает пакет.                    |
| распаковать        | Извлекает все файлы в указанном пакете в указанный выходной каталог. |

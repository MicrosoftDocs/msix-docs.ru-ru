...
>
> Мы будем использовать подробные инструкции и расположение NuGet до середины сентября 2020. Для DGSSMigration@microsoft.com получения дополнительных сведений о миграции обратитесь к нам по адресу.  

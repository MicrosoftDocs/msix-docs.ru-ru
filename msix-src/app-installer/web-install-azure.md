...
В этом разделе описано, как настроить веб-сервер Azure для размещения пакетов приложений Windows 10, а также как использовать приложения установщика для установки пакетов приложений.
...
![Снимок экрана: загрузка пакета](images/azure-upload-file.png)
...
![Снимок экрана установки приложения с веб-страницы](images/edge.png)

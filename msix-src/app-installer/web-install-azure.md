---
title: Распространение приложения для Windows 10 из веб-приложения Azure
...
ms.locfileid: "80241937"
---
# <a name="distribute-a-windows-10-app-from-an-azure-web-app"></a>Распространение приложения для Windows 10 из веб-приложения Azure
...
В этом разделе описаны шаги по настройке веб-сервера Azure для размещения пакетов приложений Windows 10 и использованию приложения установщика приложений для установки пакетов приложений.
...
![Снимок экрана создания приложения Azure](images/azure-create-app.png)
...
![Снимок экрана создания веб-приложения](images/azure-create-app-2.png)
...
![Снимок экрана отправки пакетов](images/azure-upload-file.png)
...
![Снимок экрана: Установка приложения из веб-страницы](images/edge.png)
...
![Снимок экрана: сбой сертификации](images/aws-app-cert.png)

---
author: ridomin
title: Устранение неполадок при установке с помощью файла установщика приложений | Документация Майкрософт
...
| Version | Примечания о загрузке неопубликованных приложений |
|---------|----------------|
| Построение 17134 (Обновить апреля 2018 г., версии 1803)    | Файл `.appinstaller` также доступен в папках UNC и общих папках. Также доступны настраиваемые проверки обновлений. |
...
Приложения Windows 10 могут иметь зависимости платформы, на основе платформы приложений, используемый для создания приложения. Если вы используете C# или Visual Basic, приложение потребует среду выполнения .NET и пакеты .NET Framework. Приложения C++ требуют VCLib.
...
- `.appinstaller` файл, доступны в виде `application/xml`
...
### <a name="verify-app-package-file-installation"></a>Проверка установки файл пакета приложения

- Загрузите файл пакета приложения в локальную папку и попробуйте установить его с помощью [Add-AppxPackage](https://docs.microsoft.com/powershell/module/appx/add-appxpackage?view=win10-ps) команду PowerShell.

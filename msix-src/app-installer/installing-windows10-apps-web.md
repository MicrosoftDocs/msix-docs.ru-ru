---
title: Установка приложений Windows 10 с веб-страницы
...
ms.locfileid: "89089912"
---
# <a name="installing-windows-10-apps-from-a-web-page"></a>Установка приложений Windows 10 с веб-страницы
...
1. Веб-серверы должны иметь поддержку запросов диапазона байтов (HTTP/1.1)
    - Серверы, поддерживающие протокол HTTP/1.1, должны иметь поддержку запросов диапазона байтов.
2. Веб-серверы должны знать о типах содержимого пакета приложений Windows 10
    - Вот как объявить новые типы содержимого как часть [файла веб-конфигурации](web-install-IIS.md#step-7---configure-the-web-app-for-app-package-mime-types)

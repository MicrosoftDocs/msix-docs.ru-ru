...
Запустите Visual Studio 2017 от имени **администратора** и создайте новый **проект C# визуального веб-приложения** с **пустым** шаблоном проекта. 
...
Включите следующий код HTML на веб-страницу. Ключом к успешному вызову установщика приложений является использование настраиваемой схемы, которую установщик приложения регистрирует в операционной системе: `ms-appinstaller:?source=`. Дополнительные сведения см. в приведенном ниже примере кода.
...
Откройте файл **Web. config** в обозревателе решений и добавьте в элемент `<configuration>` следующие строки. 
